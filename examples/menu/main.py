...
menu.set_screen(MenuScreen('Main Menu')
                .add(SubMenuItem('Settings')
                     .add(SubMenuItem('Date')
                          .add(ValueItem('Year', 10, 1, 100, 1, print))
                          .add(ValueItem('Month', 10, 1, 100, 1, print))
                          .add(ValueItem('Day', 10, 1, 100, 1, print)))
                     .add(SubMenuItem('Time')
                          .add(ValueItem('Hour', 10, 1, 100, 1, print))
                          .add(ValueItem('Minute', 10, 1, 100, 1, print))))
